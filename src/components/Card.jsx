...
const Card = ({title, price, storage, users, email, image, buttonColor}) => {
  return (
  <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
    ...
    <div className='text-center font-medium'>
      ...
      <p className='py-2 border-b mx-8'>{email}</p>
    </div>
    <button className='bg-green-400 w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
  </div>
  )
}
